...
public class About extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        email.setOnClickListener(v -> {
            ...
            email.putExtra(Intent.EXTRA_EMAIL, new String[]{"sridharjayaraman07@gmail.com"});
            email.putExtra(Intent.EXTRA_SUBJECT, "Sent from "+Build.BRAND+" "+Build.DEVICE);
            email.putExtra(Intent.EXTRA_TEXT, "facegram\nversion:"+BuildConfig.VERSION_NAME+"\nandroid version:"+Build.VERSION.CODENAME);
        ...
        instagram.setOnClickListener(v -> {
            ...
            String url = "https://www.instagram.com/srivasthan_akm/";
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(url));
            startActivity(i);
